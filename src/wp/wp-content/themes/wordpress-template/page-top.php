	...
	<main>
		...
		<section id="sec02">
			<div class="inner">
				...
				<ul>
					<li>2020.01.01</li>
					<li><a href="">ニュース記事のタイトルがこちらにはいります。</a></li>
				</ul>
				<ul>
					<li>2020.01.01</li>
					<li><a href="">ニュース記事のタイトルがこちらにはいります。</a></li>
		...
		<section id="sec03">
			<div class="inner">
				<h2 class="title">ABOUT <a href="">MORE</a></h2>
		...
		<section id="sec04">
			<div class="inner">
				<h2 class="title">ARTIST <a href="">MORE</a></h2>
			</div>
		...
		<section id="sec05">
			<div class="inner">
				<h2 class="title">EVENT <a href="#">MORE</a></h2>
				...
				<div class="flex-row">
					<a href="">
						<figure>
							<div></div>
							<figcaption>
								<div><span>音楽</span><em>2020.01.04</em></div>
								<p>記事のタイトルがこちらに入ります。<br>２行までで抑えます。</p>
							</figcaption>
						</figure>
					</a>
					<a href="">
